              ...
              <div className="order-2 lg:order-1 space-y-6 lg:space-y-8 text-center lg:text-left lg:mt-16">
                ...
                <div className="space-y-4 lg:space-y-6 animate-fade-in">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-800 leading-tight">
                    {t("hero.title")
                      .split(" ")
                      .map((word, index) => {
                        if (word === "Shine" || word === "Stralen" || word === "Striele") {
                          return (
                            <span
                              key={index}
                ...
                <div className="space-y-4 lg:space-y-6 animate-fade-in-up">
                  ...
                  <div className="flex flex-col gap-3 w-full max-w-sm mx-auto lg:hidden">
                    ...
                    >
                      <Link href={`/${locale}/book-service`} className="flex items-center justify-center gap-2">
                        {t("hero.requestQuote")}
                    ...
                    >
                      <Link href={`/${locale}/client-assessment`} className="flex items-center justify-center gap-2">
                  ...
                  <div className="hidden lg:flex flex-wrap gap-4 xl:gap-6">
                    ...
                    >
                      <Link href={`/${locale}/book-service`} className="flex items-center gap-2">
                        {t("hero.requestQuote")}
                    ...
                    >
                      <Link href={`/${locale}/client-assessment`} className="flex items-center gap-2">
            ...
            <div className="bg-white rounded-3xl p-12 shadow-xl border border-blue-100">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" className="bg-blue-600 hover:bg-blue-700 rounded-full px-8">
                  <Link href={`/${locale}/book-service`}>{t("transformation.getYourQuote")}</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 rounded-2xl border-0 shadow-lg overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6 text-center">
                  ...
                  <Link href={`/${locale}/services/general-cleaning`}>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 rounded-2xl border-0 shadow-lg overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6 text-center">
                  ...
                  <Link href={`/${locale}/services/solar-panel-cleaning`}>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 rounded-2xl border-0 shadow-lg overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6 text-center">
                  ...
                  <Link href={`/${locale}/services/window-cleaning`}>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 rounded-2xl border-0 shadow-lg overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-6 text-center">
                  ...
                  <Link href={`/${locale}/services/drain-cleaning`}>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-green-100">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button size="lg" className="bg-green-600 hover:bg-green-700 rounded-full px-8">
                  <Link href={`/${locale}/book-service`}>{t("whyChooseUs.getStartedToday")}</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                ...
                >
                  <Link href={`/${locale}/about`}>{t("whyChooseUs.learnMoreAboutUs")}</Link>
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-rose-100">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  <Link href={`/${locale}/book-service`}>{t("testimonials.bookYourService")}</Link>
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 rounded-full px-8">
              <Link href={`/${locale}/book-service`}>{t("cta.getFreeQuote")}</Link>
            </Button>
            <Button
              size="lg"
              variant="outline"
