          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  <Link href={`/${locale}/book-service`} className="flex items-center justify-center gap-3">
                ...
                >
                  <Link href={`/${locale}/client-assessment`} className="flex items-center justify-center gap-3">
