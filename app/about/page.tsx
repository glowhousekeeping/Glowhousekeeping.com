          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-20">
            ...
            <div className="space-y-8">
              ...
              <div className="mt-8 pt-6 border-t border-rose-200">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Connect with Glorija</h4>
                <div className="flex items-center gap-4">
                  <a
                    href="https://www.facebook.com/share/1AEG2gr3rT/?mibextid=wwXIfr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-700 rounded-full transition-all duration-300 hover:shadow-md"
                  >
                  ...
                  <a
                    href="https://www.instagram.com/gbeberina?igsh=YTJ2cWV2cjg5dnJv"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 bg-pink-50 hover:bg-pink-100 text-pink-600 hover:text-pink-700 rounded-full transition-all duration-300 hover:shadow-md"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.132-1.551-.684-.94-.684-2.102 0-3.042.684-.94 1.835-1.551 3.132-1.551s2.448.611 3.132 1.551c.684.94.684 2.102 0 3.042-.684.94-1.835 1.551-3.132 1.551zM7.718 0c-1.297 0-2.448-.611-3.132-1.551-.684-.94-.684-2.102 0-3.042.684-.94 1.835-1.551 3.132-1.551s2.448.611 3.132 1.551c.684.94.684 2.102 0 3.042-.684.94-1.835 1.551-3.132 1.551z" />
